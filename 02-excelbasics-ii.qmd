...
- Not all useful text manipulation tools are built-in though. For instance,
`WORDCOUNT`, counting the number of words in a text, does not exist. We will
revisit text manipulation later on.
