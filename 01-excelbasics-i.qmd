...
- Boolean values and the boolean functions.
...
| [`GEOMEAN`](https://exceljet.net/functions/geomean-function) | The geometric mean of the numbers in a range.
