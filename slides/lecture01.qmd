...
-   In this lecture I use the desktop version -- but you can use the online version too. For now.
...
-   I use the Norwegian locale, where "0,0" is a decimal number. In the English locale, "0.0" is a decimal number. **This is important! It also affects formulas, as you must modify ':' to ','!**

## But recall

![](images/paste-420ACEF1.png)

## Getting started

-   Cells, active cells, and blank cells
-   Data entry
...
-   The operations can be combined, e.g., `=(1+2)/3`.
-   You can use references, e.g., `=A1+B1` instead of hard coded formulas.

## Formuas

### `SUM` function

-   Use the `SUM` function to sum load of numbers at once.
...
This survey contains three simple questions. Answering the survey helps us organize the course better. http://bitly.ws/xSZK
